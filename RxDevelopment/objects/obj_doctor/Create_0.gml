...
text[4] = "Apparently you do! This is pretty amaz-";
...
text[9] = "They cause trouble by DOUBLING! Quick, you've got the wand! Use it to make them disappear by pressing 'J' or the 'Left Mouse Button'! Make sure you get ALL OF THEM! (Press 'E' to exit text)";
