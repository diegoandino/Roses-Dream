...
text[9] = "They cause trouble by DOUBLING! Quick, you've got the wand! Make them disappear by pressing 'S' or 'Left Mouse Button'! Make sure you get ALL OF THEM! (Press 'E' to exit text)";
